            ...
            <div class="card">
               <div class="profileimage">
                  ...
                  if (user.Profile_pic == null) {
                     return `
               <svg class="pfp" version="1.1" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <g>
                     ...
                     return `<img class="profile_pic" src="${user.Profile_pic}" alt="">`
               })()}
               </div>
               <div class="Name">
                  <a href="#" onclick="onClickCard('${user.username}')">${user.username}</a>
               </div>
               <div class="socialbar">
                  ${(() => {
                  if (user.github != null)
                     return `<i class="bi bi-github" id="github"><a href="${user.github}"></a></i>`
                  return "";
               })()}
                  ${(() => {
                  if (user.instagram != null)
                     return `<i class="bi bi-instagram" id="instagram"><a href="${user.instagram}"></a></i>`
                  return "";
               })()}
                  ${(() => {
                  if (user.twitter != null)
                     return `<i class="bi bi-twitter" id="twitter"><a href="${user.twitter}"></a></i>`
                  return "";
               })()}
                  ${(() => {
                  if (user.linkedin != null)
                     return `<i class="bi bi-linkedin" id="linkedin"><a href="${user.linkedin}"></a></i>`
                  return "";
               })()}
                  ${(() => {
                  if (user.facebook != null)
                     return `<i class="bi bi-facebook" id="facebook"><a href="${user.facebook}"></a></i>`
                  return "";
               })()}
               </div>
            </div>
